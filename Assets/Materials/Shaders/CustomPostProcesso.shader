...
Shader "CustomPostProcesso"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEBegin]_PixelsX("PixelsX", Range( 16 , 2000)) = 500.4767
		_PixelsY("PixelsY", Range( 16 , 2000)) = 246.2272
		[HideInInspector]_MainTex("MainTex", 2D) = "white" {}
		[IntRange]_AspectRatio("AspectRatio", Range( 0 , 1)) = 0
		[ASEEnd]_PixelAspectRatio("Pixel AspectRatio", Range( 16 , 2000)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float pixelWidth5 =  1.0f / _PixelsX;
				float pixelHeight5 = 1.0f / _PixelsY;
				half2 pixelateduv5 = half2((int)(texCoord21.x / pixelWidth5) * pixelWidth5, (int)(texCoord21.y / pixelHeight5) * pixelHeight5);
				float pixelWidth30 =  1.0f / ( _PixelAspectRatio * 1.777778 );
				float pixelHeight30 = 1.0f / _PixelAspectRatio;
				half2 pixelateduv30 = half2((int)(texCoord21.x / pixelWidth30) * pixelWidth30, (int)(texCoord21.y / pixelHeight30) * pixelHeight30);
				float2 lerpResult29 = lerp( pixelateduv5 , pixelateduv30 , _AspectRatio);
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = tex2D( _MainTex, lerpResult29 ).rgb;
				float Alpha = 1;
...
ASEEND*/
//CHKSM=DC0126914BC232FCC3A43BE46825E78F7A24C037